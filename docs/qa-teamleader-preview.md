...
## 5. Step 9~10 1on1 Flow QA

- [ ] Step 9에 1on1 대상 선택 보드가 표시된다.
- [ ] Step 9에서 관찰 사실, 영향, 대화 목적, 대화 순서가 구분된다.
- [ ] Step 9의 AI 과제 지시문이 대상 선정 이유와 첫 질문 후보를 만들도록 안내한다.
- [ ] Step 10에 1on1 대화 실천 보드가 표시된다.
- [ ] Step 10에서 시작, 확인, 합의, 후속 점검이 구분된다.
- [ ] Step 10의 AI 과제 지시문이 대화 시작 문장, 확인 질문, 합의 행동, 점검 문장을 만들도록 안내한다.
...
- [ ] `src/teamleader/StepPracticePanel.jsx`가 공통 실습 UI와 실행 Flow UI를 담당한다.
- [ ] `src/teamleader/oneToOnePractice.js`가 Step 9~10 1on1 설정을 담당한다.
